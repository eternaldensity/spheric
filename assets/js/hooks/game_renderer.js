  ...
  _updateFuelHUD() {
    ...
    for (let i = 0; i < data.slots.length; i++) {
      ...
      if (!slot) {
        ...
        const cls = slot.type === "refined_fuel" ? "fuel-refined" : slot.type === "catalysed_fuel" ? "fuel-catalysed" :  slot.type === "unstable_fuel" ? "fuel-unstable" : slot.type === "stable_fuel" ? "fuel-stable" :"fuel-biofuel";
