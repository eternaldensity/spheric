...
Approximately **0.1% of tiles** contain an **Altered Item** — a permanent paranatural anomaly embedded in the terrain. When you build on an Altered Item tile, that building gains a special bonus.

## Altered Item Types

| Altered Item | Effect | Details |
|---|---|---|
...
| Shifting Anchor | Skip downstream | Output items bypass the next building in the [[The Conduit Network|chain]] |

## Finding Altered Items

- Click on any tile — the info panel shows **"Altered Item"** if one is present
- They have a distinctive visual indicator on the sphere
...
| Shifting Anchor | Specific [[The Conduit Network|Conduit]] routing optimizations |

## Altered Resonance (Late Game)

At Clearance 6, the **[[Objects of Power|Altered Resonance]]** Object of Power **doubles** all Altered Item effects. See [[Altered Items Reference]] for the doubled values.

---

**Previous:** [[World Events]] | **Next:** [[Mid Game Tips]]
