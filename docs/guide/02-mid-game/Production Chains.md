...
> [!warning] Mid Game Content
> This page covers Clearance 2+ mechanics. If you're still in the early game, return to [[Early Game Tips]].
...
At a high level, production flows through tiers:
...
Each tier requires the outputs of the tier below it. Planning your layout to accommodate these chains is the core challenge of the mid game.
