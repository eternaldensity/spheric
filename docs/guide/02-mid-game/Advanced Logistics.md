...
- Accepts items from several directions, sends them all in one direction
- Use to consolidate multiple production lines into one stream
...
- **1 input → 4 outputs**
- Distributes items evenly across all four directions in round-robin
- Ideal for feeding four parallel production lines
...
- Bridges distant [[Power & Energy#Substation|Substations]]
- Allows power networks to reach across gaps
- Advanced logistics hub for large-scale factories

**Cost:** 10 Shielded Conduit, 2 Astral Frame, 3 Resonance Circuit
