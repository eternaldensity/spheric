...
These outputs are required for Fabrication Plant recipes and higher.

**Cost:** 2 Heavy Astral Frame, 3 Adv. Resonance Circuit, 2 Kinetic Driver

## Fabrication Plant

*Unlocked at Clearance 5*

The first **triple-input** building — requires three different materials.
...
Extracts **Anomalous Essence** from [[Creatures & Containment|assigned creatures]], producing the biofuel that powers your [[Power & Energy|Bio Generators]].

**Cost:** 3 Astral Frame, 5 Resonance Circuit, 10 Refined Resonance Crystal

---

See [[Recipe Reference]] for all recipes and [[Building Reference]] for all costs.

**Previous:** [[Power & Energy]] | **Next:** [[Trading with Other Operators]]
