...
| Astral Ore (Raw) | Astral Ingot |
| Resonance Crystal (Raw) | Refined Resonance Crystal |
...
| Input | Output |
|---|---|
| Black Rock Ichor (Crude) | Stabilized Polymer |
| Threshold Dust (Raw) | Threshold Compound |
| Entity Biofuel | Refined Entity Fuel |
