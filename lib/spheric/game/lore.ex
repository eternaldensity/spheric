defmodule Spheric.Game.Lore do
  ...
  def display_name(:filtered_splitter), do: "Selective Distributor"
  def display_name(:overflow_gate), do: "Surplus Router"
  def display_name(:priority_merger), do: "Priority Converger"
