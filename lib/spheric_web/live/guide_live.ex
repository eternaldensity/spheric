defmodule SphericWeb.GuideLive do
  ...
  @pages %{
    ...
    "the-conduit-network" => "01-early-game/The Conduit Network.md",
    "the-conveyor-network" => "01-early-game/The Conduit Network.md",
  ...
  @nav [
    ...
    {"Early Game", "hero-play",
     [
       ...
       {"The Conduit Network", "the-conduit-network"},
